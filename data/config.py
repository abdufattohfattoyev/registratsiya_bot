...
# .env fayl manzilini aniq ko‘rsatamiz
...
print("🔧 KONFIGURATSIYA YUKLANDI")
print("=" * 40)
print(f"🤖 BOT_TOKEN: {'✅ Mavjud' if BOT_TOKEN else '❌ Yo`q'}")
print(f"👨‍💼 ADMINS: {ADMINS}")
print(f"📊 SPREADSHEET_ID: {SPREADSHEET_ID if SPREADSHEET_ID else '📝 Avtomatik yaratiladi'}")
print(f"🗂 GOOGLE_CREDENTIALS: {GOOGLE_CREDENTIALS_FILE}")
print(f"🌐 IP: {IP}")
